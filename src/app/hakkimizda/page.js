    ...
    <div className="bg-[#050505] min-h-screen selection:bg-[#FF8A00] selection:text-black cursor-none font-sans overflow-x-hidden">
      ...
      <section className="relative py-24 md:py-40 border-t border-white/5 flex items-center justify-center text-center overflow-hidden">
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="relative z-10 px-4 w-full">
          <motion.h2 variants={fadeUp} className="text-4xl sm:text-5xl md:text-8xl font-black text-white mb-6 md:mb-8 tracking-tighter">İz Bırakmaya <br/> Hazır Mısınız?</motion.h2>
